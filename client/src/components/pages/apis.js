			...
			<div>
				...
				<section>
					<p style={{textAlign: "left"}} className="mb-3">
						...
						<button type="button" className="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#paramModal">View Details</button>
					</p>
					<div>
					...
					<div>
						...
						<button className="btn btn-primary" style={{ margin: "5px 0" }} onClick={this.fetchRandomArray}>Fetch Array</button> <br/>
